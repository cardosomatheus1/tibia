...
-- Hunt instanciada: o jogador dentro de uma instancia esta em x >= 36864 e o
-- minimapa fica preto, porque e' client-side e indexado por coordenada
-- absoluta. Traduzir aqui, na EXIBICAO, faz ele se ver no lugar equivalente da
-- hunt publica -- e reaproveita o minimap.otmm que ja vem no client.
-- Cosmetico: a verdade do servidor continua 36864.
local INSTANCIA_ORIGEM = { x = 32384, y = 32016 }
local INSTANCIA_LARG, INSTANCIA_ALT = 169, 121
local INSTANCIA_SLOTS = {
	{ x = 36864, y = 36864 }, { x = 37376, y = 36864 }, { x = 37888, y = 36864 },
	{ x = 38400, y = 36864 }, { x = 38912, y = 36864 }, { x = 39424, y = 36864 },
}

local function instancia_traduzir(pos)
