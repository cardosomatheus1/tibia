-- Seletor de entrada de Brain Grounds - Jakundaf - -1-2-3.
...
if not (HuntInstances and HuntInstances.brainGroundsJakundaf123) then
	dofile(DATA_DIRECTORY .. "/scripts/custom/hunt_instances/catalogo_brain_grounds_jakundaf_1_2_3.lua")
end

local template = HuntInstances.brainGroundsJakundaf123
