-- Seletor de entrada de Haunted Nexus - Ripper+Arac.
...
if not (HuntInstances and HuntInstances.hauntedNexusRipperArac) then
	dofile(DATA_DIRECTORY .. "/scripts/custom/hunt_instances/catalogo_haunted_nexus_ripper_arac.lua")
end

local template = HuntInstances.hauntedNexusRipperArac
