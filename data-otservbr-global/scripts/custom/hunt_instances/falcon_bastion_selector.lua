-- Seletor de entrada de Falcon Bastion.
...
if not (HuntInstances and HuntInstances.falconBastion) then
	dofile(DATA_DIRECTORY .. "/scripts/custom/hunt_instances/catalogo_falcon_bastion.lua")
end

local template = HuntInstances.falconBastion
